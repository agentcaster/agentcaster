"""
Plot a Wind Speed vs. Height display using SHARPpy's native Qt visualization
"""
import os
import sys
import numpy as np
...
from sharppy.viz.speed import plotSpeed

class MainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle('SHARPpy Wind Speed vs. Height')
        self.resize(800, 600)
