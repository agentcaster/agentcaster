"""
Plot a Significant Hail Parameter (SHIP) display using SHARPpy's native Qt visualization
"""
import os
import sys
import numpy as np
...
from sharppy.viz.ship import plotSHIP

class MainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle('SHARPpy Significant Hail Parameter (SHIP)')
        self.resize(800, 600)
