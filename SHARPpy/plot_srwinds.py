"""
Plot a Storm-Relative Winds vs. Height display using SHARPpy's native Qt visualization
"""
import os
import sys
import numpy as np
...
class MainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle('SHARPpy Storm-Relative Winds vs. Height')
        self.resize(800, 600)
